 ...
 */
public class UpdateProfileRequest implements RestResponse {
    ...
    public UpdateProfileRequest(String login, String firstName, String lastName, String emailAddress, String address1, String address2, String zipCode, String city, String state, String country, boolean publicProfile) {
        this.login = login;
